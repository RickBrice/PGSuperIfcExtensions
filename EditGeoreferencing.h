...
class txnEditGeoreferencing : public WBFL::EAF::Transaction
{
public:
   txnEditGeoreferencing(const GeoreferencingData& oldData, const GeoreferencingData& newData);
